        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Slots_Nutritionists_NutritionistId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Consultations_Nutritionists_NutritionistId",
                        column: x => x.NutritionistId,
                        principalTable: "Nutritionists",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Consultations_NutritionistId",
                table: "Consultations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Slots_NutritionistId_StartTime",
                table: "Slots",
                columns: new[] { "NutritionistId", "StartTime" },
                unique: true,
                filter: "\"Status\" != 2");
        }
